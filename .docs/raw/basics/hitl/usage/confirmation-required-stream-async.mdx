---
title: Confirmation Required with Async Streaming
sidebarTitle: Stream Confirmation
keywords: [confirmation, async streaming, arun stream, real-time async]
...
<Steps>
  ...
  <Step title="Create a Python file">
    ...
    ```bash
    touch confirmation_required_stream_async.py
    ```
  </Step>
