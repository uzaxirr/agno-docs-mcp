---
title: Confirmation Required with History
sidebarTitle: Confirmation with History
keywords: [confirmation, history, conversation context, add_history_to_context]
...
<Steps>
  ...
  <Step title="Create a Python file">
    ...
    ```bash
    touch confirmation_required_with_history.py
    ```
  </Step>
