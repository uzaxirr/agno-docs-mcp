...
This example demonstrates how to use a pre-hook to validate the input of an Agent, before it is presented to the LLM.
...
<Steps>
  ...
  <Step title="Run example">
    <CodeGroup>
    ```bash Mac
    python cookbook/03_agents/hooks/input_validation_pre_hook.py
    ```
