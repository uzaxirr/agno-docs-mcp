...
This example demonstrates how to use a post-hook to validate the output of an Agent, before it is returned to the user.
...
<Steps>
  ...
  <Step title="Run example">
    <CodeGroup>
    ```bash Mac
    python cookbook/03_agents/hooks/output_validation_post_hook.py
    ```
