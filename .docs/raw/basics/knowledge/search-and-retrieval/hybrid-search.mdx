...
keywords: [hybrid search, keyword search, vector search, search]
---
...
## See More Examples
For hands-on code and advanced usage, check out these hybrid search examples for each supported vector database [here](/examples/basics/vectordb/lance-db/lance-db-hybrid-search)
