...
<Steps>
  ...
  <Step title="Run the example">
    <CodeGroup>
    ```bash Mac
    python cookbook/08_knowledge/custom_retriever/async_retriever.py
    ```

    ```bash Windows
    python examples/basics/knowledge/custom_retriever/async_retriever.py
    ```
    </CodeGroup>
  </Step>
</Steps>
