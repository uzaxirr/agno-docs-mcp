...
The workflow will guide you through four validation phases: concept clarification, originality evaluation, mission definition, and market research. You'll receive objective feedback on your startup idea with detailed analysis of market opportunity, competition, and target segments.

The final output is a comprehensive validation report with insights on total addressable market, competitive landscape, and actionable recommendations to refine your business concept before investing resources.
...
- Modify the startup idea input to validate different business concepts
- Customize agent instructions to focus on specific validation criteria
- Adjust market research parameters to target different industries
