...
`AIMLAPI` extends the OpenAI-compatible interface and supports most parameters from the [OpenAI model](/integrations/models/native/openai/completion/overview), where applicable.
