...
<Note> View more examples [here](/integrations/models/gateways/fireworks/usage/basic). </Note>
...
`Fireworks` extends the OpenAI-compatible interface and supports most parameters from the [OpenAI model](/integrations/models/native/openai/completion/overview).
