...
<Note> View more examples [here](/integrations/models/gateways/nvidia/usage/basic-stream). </Note>
...
`NVIDIA` extends the OpenAI-compatible interface and supports most parameters from the [OpenAI model](/integrations/models/native/openai/completion/overview).
