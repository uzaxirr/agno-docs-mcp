...
<Note> View more examples [here](/integrations/models/native/vercel/usage/basic). </Note>
...
V0 extends the OpenAI-compatible interface and supports most parameters from the [OpenAI model](/integrations/models/native/openai/completion/overview).
