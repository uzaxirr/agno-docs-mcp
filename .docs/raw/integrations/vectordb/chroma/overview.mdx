...
description: Learn how to use ChromaDB as a vector database for your Knowledge Base
---
...
- View [Cookbook (Sync)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/chroma_db/chroma_db.py)
- View [Cookbook (Async)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/chroma_db/async_chroma_db.py)
- View [Cookbook (Hybrid Search)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/chroma_db/chroma_db_hybrid_search.py)
