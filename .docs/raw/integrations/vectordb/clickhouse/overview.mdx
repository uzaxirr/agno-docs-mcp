...
description: Learn how to use Clickhouse as a vector database for your Knowledge Base
---
...
- View [Cookbook (Sync)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/clickhouse_db/clickhouse.py)
- View [Cookbook (Async)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/clickhouse_db/async_clickhouse.py)
