...
description: Learn how to use Couchbase as a vector database for your Knowledge Base
---
...
- View [Cookbook (Sync)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/couchbase_db/couchbase_db.py)
- View [Cookbook (Async)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/couchbase_db/async_couchbase_db.py)