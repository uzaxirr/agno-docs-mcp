...
description: Learn how to use PgVector as a vector database for your Knowledge Base
---
...
- View [Cookbook (Sync)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/pgvector/pgvector_db.py)
- View [Cookbook (Async)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/pgvector/async_pg_vector.py)
