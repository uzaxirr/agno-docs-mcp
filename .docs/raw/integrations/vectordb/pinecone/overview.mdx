...
description: Learn how to use Pinecone as a vector database for your Knowledge Base
---
...
- View [Cookbook (Sync)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/pinecone_db/pinecone_db.py)