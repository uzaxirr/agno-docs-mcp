...
description: Learn how to use SingleStore as a vector database for your Knowledge Base
---
...
- View [Cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/singlestore_db/singlestore_db.py)
